...
def algorithm(melody):
    ...
    (unigrams, bigrams, trigrams, tetragrams, given) = (chords_major_unigrams, chords_major_bigrams,  
                                            ...
                                            (chords_minor_unigrams, chords_minor_bigrams,
                                            chords_minor_trigrams, chords_minor_tetragrams, chords_minor_given)
    transposed_melody = util.notes_names([note for note in melody], util.key(melody))
    
    # Viterbi algorithm
    obs = transposed_melody
    chord_types = util.chord_names
    ...
    #return algorithm.algorithm(transposed_melody, unigrams, bigrams, trigrams, tetragrams, given)
